  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-white">Órdenes de taller</h2>
          <p className="text-white/55">Vista tipo tablero por estado</p>
        </div>
        <Button asChild>
      ...
      {ordenes.length === 0 && (
        <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-white/15 py-16">
          <Wrench className="mb-3 h-12 w-12 text-white/25" />
          <p className="text-white/55">No hay órdenes cargadas.</p>
        </div>
      )}
    </div>
  );
